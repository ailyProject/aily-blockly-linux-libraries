/* Curated CircuitPython AHTx0 bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython AHTx0",
    "prefix": "python_adafruit_ahtx0",
    "module": "adafruit_ahtx0",
    "alias": "_python_lib_adafruit_ahtx0",
    "importKey": "python_lib_adafruit_ahtx0",
    "callables": [
      "AHTx0"
    ],
    "methods": [],
