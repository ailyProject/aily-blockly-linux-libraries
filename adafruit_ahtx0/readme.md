# CircuitPython AHTx0 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython AHTx0 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-ahtx0`
- 积木（3 个）：`python_adafruit_ahtx0_call`、`python_adafruit_ahtx0_do`、`python_adafruit_ahtx0_attribute`
- 可调用入口：`AHTx0`
- 对象方法：无
- 对象/模块属性：`temperature`、`relative_humidity`
- API 文档：https://docs.circuitpython.org/projects/ahtx0/en/latest/
