# @aily-project/lib-adafruit-ahtx0

Curated CircuitPython AHTx0 integration for the standalone CPython generator at `globalThis.Python`.

- Import: `import adafruit_ahtx0 as _python_lib_adafruit_ahtx0`
- Install on target: `python3 -m pip install adafruit-circuitpython-ahtx0`
- Blocks (3): `python_adafruit_ahtx0_call`, `python_adafruit_ahtx0_do`, `python_adafruit_ahtx0_attribute`
- Allowlisted callables: `AHTx0`
- Allowlisted methods: none
- Allowlisted attributes: `temperature`, `relative_humidity`
- API source: https://docs.circuitpython.org/projects/ahtx0/en/latest/
...
. .venv/bin/activate
python3 -m pip install --upgrade Adafruit-Blinka adafruit-circuitpython-ahtx0
```
