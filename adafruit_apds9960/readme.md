# CircuitPython APDS9960 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython APDS9960 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-apds9960`
- 积木（5 个）：`python_adafruit_apds9960_call`、`python_adafruit_apds9960_do`、`python_adafruit_apds9960_method`、`python_adafruit_apds9960_do_method`、`python_adafruit_apds9960_attribute`
- 可调用入口：`APDS9960`
- 对象方法：`gesture`
- 对象/模块属性：`enable_proximity`、`enable_gesture`、`enable_color`、`color_data`、`proximity`
- API 文档：https://docs.circuitpython.org/projects/apds9960/en/latest/
