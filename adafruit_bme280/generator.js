/* Curated CircuitPython BME280 bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython BME280",
    "prefix": "python_adafruit_bme280",
    "module": "adafruit_bme280.basic",
    "alias": "_python_lib_adafruit_bme280",
    "importKey": "python_lib_adafruit_bme280",
    "callables": [
      "Adafruit_BME280_I2C",
      "Adafruit_BME280_SPI"
    ],
