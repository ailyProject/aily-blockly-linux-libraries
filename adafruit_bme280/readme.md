# CircuitPython BME280 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython BME280 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-bme280`
- 积木（3 个）：`python_adafruit_bme280_call`、`python_adafruit_bme280_do`、`python_adafruit_bme280_attribute`
- 可调用入口：`Adafruit_BME280_I2C`、`Adafruit_BME280_SPI`
- 对象方法：无
- 对象/模块属性：`temperature`、`pressure`、`humidity`、`altitude`、`sea_level_pressure`、`mode`、`standby_period`、`iir_filter`
- API 文档：https://docs.circuitpython.org/projects/bme280/en/latest/
