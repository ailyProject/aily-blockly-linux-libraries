# @aily-project/lib-adafruit-bme280

Curated CircuitPython BME280 integration for the standalone CPython generator at `globalThis.Python`.

- Import: `import adafruit_bme280.basic as _python_lib_adafruit_bme280`
- Install on target: `python3 -m pip install adafruit-circuitpython-bme280`
- Blocks (3): `python_adafruit_bme280_call`, `python_adafruit_bme280_do`, `python_adafruit_bme280_attribute`
- Allowlisted callables: `Adafruit_BME280_I2C`, `Adafruit_BME280_SPI`
- Allowlisted methods: none
- Allowlisted attributes: `temperature`, `pressure`, `humidity`, `altitude`, `sea_level_pressure`, `mode`, `standby_period`, `iir_filter`
- API source: https://docs.circuitpython.org/projects/bme280/en/latest/
