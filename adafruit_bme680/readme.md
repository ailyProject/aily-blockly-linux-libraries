# CircuitPython BME680 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython BME680 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-bme680`
- 积木（3 个）：`python_adafruit_bme680_call`、`python_adafruit_bme680_do`、`python_adafruit_bme680_attribute`
- 可调用入口：`Adafruit_BME680_I2C`、`Adafruit_BME680_SPI`
- 对象方法：无
- 对象/模块属性：`temperature`、`pressure`、`humidity`、`altitude`、`gas`、`sea_level_pressure`
- API 文档：https://docs.circuitpython.org/projects/bme680/en/latest/
