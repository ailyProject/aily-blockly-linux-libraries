/* Curated CircuitPython BNO055 bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython BNO055",
    "prefix": "python_adafruit_bno055",
    "module": "adafruit_bno055",
    "alias": "_python_lib_adafruit_bno055",
    "importKey": "python_lib_adafruit_bno055",
    "callables": [
      "BNO055_I2C",
      "BNO055_UART"
    ],
