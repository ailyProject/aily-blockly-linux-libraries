# CircuitPython CCS811 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython CCS811 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-ccs811`
- 积木（5 个）：`python_adafruit_ccs811_call`、`python_adafruit_ccs811_do`、`python_adafruit_ccs811_method`、`python_adafruit_ccs811_do_method`、`python_adafruit_ccs811_attribute`
- 可调用入口：`CCS811`
- 对象方法：`reset`
- 对象/模块属性：`eco2`、`tvoc`、`data_ready`、`baseline`、`temperature`、`drive_mode`
- API 文档：https://docs.circuitpython.org/projects/ccs811/en/latest/
...
支持级别：有条件。CCS811 存在 I2C clock stretching；必要时将 I2C 波特率降至 10 kHz。
