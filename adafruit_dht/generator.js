/* Curated CircuitPython DHT bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython DHT",
    "prefix": "python_adafruit_dht",
    "module": "adafruit_dht",
    "alias": "_python_lib_adafruit_dht",
    "importKey": "python_lib_adafruit_dht",
    "callables": [
      "DHT11",
      "DHT22"
    ],
