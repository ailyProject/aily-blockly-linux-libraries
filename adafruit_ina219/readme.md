# CircuitPython INA219 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython INA219 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-ina219`
- 积木（5 个）：`python_adafruit_ina219_call`、`python_adafruit_ina219_do`、`python_adafruit_ina219_method`、`python_adafruit_ina219_do_method`、`python_adafruit_ina219_attribute`
- 可调用入口：`INA219`
- 对象方法：`reset`
- 对象/模块属性：`bus_voltage`、`current`、`power`、`shunt_voltage`、`conversion_ready`、`overflow`、`bus_adc_resolution`、`shunt_adc_resolution`、`mode`
- API 文档：https://docs.circuitpython.org/projects/ina219/en/latest/
