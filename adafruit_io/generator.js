/* Curated Adafruit IO bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "Adafruit IO",
    "prefix": "python_adafruit_io",
    "module": "Adafruit_IO",
    "alias": "_python_lib_adafruit_io",
    "importKey": "python_lib_adafruit_io",
    "callables": [
      "Client",
      "MQTTClient",
      "Feed",
