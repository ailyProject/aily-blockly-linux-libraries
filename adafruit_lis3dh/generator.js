/* Curated CircuitPython LIS3DH bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython LIS3DH",
    "prefix": "python_adafruit_lis3dh",
    "module": "adafruit_lis3dh",
    "alias": "_python_lib_adafruit_lis3dh",
    "importKey": "python_lib_adafruit_lis3dh",
    "callables": [
      "LIS3DH_I2C",
      "LIS3DH_SPI"
    ],
