# CircuitPython LIS3DH Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython LIS3DH 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-lis3dh`
- 积木（5 个）：`python_adafruit_lis3dh_call`、`python_adafruit_lis3dh_do`、`python_adafruit_lis3dh_method`、`python_adafruit_lis3dh_do_method`、`python_adafruit_lis3dh_attribute`
- 可调用入口：`LIS3DH_I2C`、`LIS3DH_SPI`
- 对象方法：`set_tap`、`unset_tap`
- 对象/模块属性：`acceleration`、`range`、`data_rate`、`click`、`tapped`
- API 文档：https://docs.circuitpython.org/projects/lis3dh/en/latest/
