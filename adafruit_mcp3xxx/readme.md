# CircuitPython MCP3xxx Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython MCP3xxx 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-mcp3xxx`
- 积木（5 个）：`python_adafruit_mcp3xxx_call`、`python_adafruit_mcp3xxx_do`、`python_adafruit_mcp3xxx_method`、`python_adafruit_mcp3xxx_do_method`、`python_adafruit_mcp3xxx_attribute`
- 可调用入口：`MCP3008`、`AnalogIn`
- 对象方法：`read`
- 对象/模块属性：`P0`、`P1`、`P2`、`P3`、`P4`、`P5`、`P6`、`P7`、`value`、`voltage`、`reference_voltage`
- API 文档：https://docs.circuitpython.org/projects/mcp3xxx/en/latest/
...
生成器从 `adafruit_mcp3xxx.mcp3008` 导入 `MCP3008` 与 `P0` 至 `P7`，从 `adafruit_mcp3xxx.analog_in` 导入 `AnalogIn`。`value`、`voltage`、`reference_voltage` 读取属性积木连接的对象。
