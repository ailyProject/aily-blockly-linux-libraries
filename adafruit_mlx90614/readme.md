# CircuitPython MLX90614 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython MLX90614 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-mlx90614`
- 积木（3 个）：`python_adafruit_mlx90614_call`、`python_adafruit_mlx90614_do`、`python_adafruit_mlx90614_attribute`
- 可调用入口：`MLX90614`
- 对象方法：无
- 对象/模块属性：`ambient_temperature`、`object_temperature`
- API 文档：https://docs.circuitpython.org/projects/mlx90614/en/latest/
