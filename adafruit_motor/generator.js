/* Curated CircuitPython Motor bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython Motor",
    "prefix": "python_adafruit_motor",
    "module": "adafruit_motor.motor",
    "alias": "_python_lib_adafruit_motor",
    "importKey": "python_lib_adafruit_motor",
    "callables": [
      "DCMotor"
    ],
    "methods": [],
