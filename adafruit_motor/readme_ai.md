# @aily-project/lib-adafruit-motor

Curated CircuitPython Motor integration for the standalone CPython generator at `globalThis.Python`.

- Import: `import adafruit_motor.motor as _python_lib_adafruit_motor`
- Install on target: `python3 -m pip install adafruit-circuitpython-motor`
- Blocks (3): `python_adafruit_motor_call`, `python_adafruit_motor_do`, `python_adafruit_motor_attribute`
- Allowlisted callables: `DCMotor`
- Allowlisted methods: none
- Allowlisted attributes: `throttle`, `decay_mode`, `SLOW_DECAY`, `FAST_DECAY`
- API source: https://docs.circuitpython.org/projects/motor/en/latest/
