/* Curated CircuitPython MotorKit bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython MotorKit",
    "prefix": "python_adafruit_motorkit",
    "module": "adafruit_motorkit",
    "alias": "_python_lib_adafruit_motorkit",
    "importKey": "python_lib_adafruit_motorkit",
    "callables": [
      "MotorKit"
    ],
    "methods": [],
