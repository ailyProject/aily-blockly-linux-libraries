# CircuitPython MotorKit Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython MotorKit 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-motorkit`
- 积木（3 个）：`python_adafruit_motorkit_call`、`python_adafruit_motorkit_do`、`python_adafruit_motorkit_attribute`
- 可调用入口：`MotorKit`
- 对象方法：无
- 对象/模块属性：`motor1`、`motor2`、`motor3`、`motor4`、`stepper1`、`stepper2`
- API 文档：https://docs.circuitpython.org/projects/motorkit/en/latest/
