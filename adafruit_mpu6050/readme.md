# CircuitPython MPU6050 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython MPU6050 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-mpu6050`
- 积木（5 个）：`python_adafruit_mpu6050_call`、`python_adafruit_mpu6050_do`、`python_adafruit_mpu6050_method`、`python_adafruit_mpu6050_do_method`、`python_adafruit_mpu6050_attribute`
- 可调用入口：`MPU6050`
- 对象方法：`reset`
- 对象/模块属性：`acceleration`、`gyro`、`temperature`、`cycle_rate`、`filter_bandwidth`、`gyro_range`、`accelerometer_range`、`cycle`
- API 文档：https://docs.circuitpython.org/projects/mpu6050/en/latest/
