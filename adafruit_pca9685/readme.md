# CircuitPython PCA9685 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython PCA9685 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-pca9685`
- 积木（5 个）：`python_adafruit_pca9685_call`、`python_adafruit_pca9685_do`、`python_adafruit_pca9685_method`、`python_adafruit_pca9685_do_method`、`python_adafruit_pca9685_attribute`
- 可调用入口：`PCA9685`
- 对象方法：`reset`、`deinit`
- 对象/模块属性：`frequency`、`channels`
- API 文档：https://docs.circuitpython.org/projects/pca9685/en/latest/
