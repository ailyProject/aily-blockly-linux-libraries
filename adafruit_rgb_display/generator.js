/* Curated CircuitPython RGB Display bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython RGB Display",
    "prefix": "python_adafruit_rgb_display",
    "module": "adafruit_rgb_display.st7789",
    "alias": "_python_lib_adafruit_rgb_display",
    "importKey": "python_lib_adafruit_rgb_display",
    "callables": [
      "ST7789"
    ],
    "methods": [
