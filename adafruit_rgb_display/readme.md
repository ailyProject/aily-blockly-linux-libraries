# CircuitPython RGB Display Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython RGB Display 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-rgb-display`
- 积木（5 个）：`python_adafruit_rgb_display_call`、`python_adafruit_rgb_display_do`、`python_adafruit_rgb_display_method`、`python_adafruit_rgb_display_do_method`、`python_adafruit_rgb_display_attribute`
- 可调用入口：`ST7789`
- 对象方法：`image`
- 对象/模块属性：`width`、`height`、`rotation`
- API 文档：https://docs.circuitpython.org/projects/rgb_display/en/latest/
