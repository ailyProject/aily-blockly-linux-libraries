/* Curated CircuitPython SCD4x bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython SCD4x",
    "prefix": "python_adafruit_scd4x",
    "module": "adafruit_scd4x",
    "alias": "_python_lib_adafruit_scd4x",
    "importKey": "python_lib_adafruit_scd4x",
    "callables": [
      "SCD4X"
    ],
    "methods": [
