/* Curated CircuitPython ServoKit bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython ServoKit",
    "prefix": "python_adafruit_servokit",
    "module": "adafruit_servokit",
    "alias": "_python_lib_adafruit_servokit",
    "importKey": "python_lib_adafruit_servokit",
    "callables": [
      "ServoKit"
    ],
    "methods": [],
