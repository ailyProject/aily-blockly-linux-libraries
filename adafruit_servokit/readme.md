# CircuitPython ServoKit Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython ServoKit 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-servokit`
- 积木（3 个）：`python_adafruit_servokit_call`、`python_adafruit_servokit_do`、`python_adafruit_servokit_attribute`
- 可调用入口：`ServoKit`
- 对象方法：无
- 对象/模块属性：`servo`、`continuous_servo`、`frequency`
- API 文档：https://docs.circuitpython.org/projects/servokit/en/latest/
