# @aily-project/lib-adafruit-servokit

Curated CircuitPython ServoKit integration for the standalone CPython generator at `globalThis.Python`.

- Import: `import adafruit_servokit as _python_lib_adafruit_servokit`
- Install on target: `python3 -m pip install adafruit-circuitpython-servokit`
- Blocks (3): `python_adafruit_servokit_call`, `python_adafruit_servokit_do`, `python_adafruit_servokit_attribute`
- Allowlisted callables: `ServoKit`
- Allowlisted methods: none
- Allowlisted attributes: `servo`, `continuous_servo`, `frequency`
- API source: https://docs.circuitpython.org/projects/servokit/en/latest/
...
. .venv/bin/activate
python3 -m pip install --upgrade Adafruit-Blinka adafruit-circuitpython-servokit
```
