/* Curated CircuitPython SGP30 bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython SGP30",
    "prefix": "python_adafruit_sgp30",
    "module": "adafruit_sgp30",
    "alias": "_python_lib_adafruit_sgp30",
    "importKey": "python_lib_adafruit_sgp30",
    "callables": [
      "Adafruit_SGP30"
    ],
    "methods": [
