# CircuitPython SGP30 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython SGP30 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-sgp30`
- 积木（5 个）：`python_adafruit_sgp30_call`、`python_adafruit_sgp30_do`、`python_adafruit_sgp30_method`、`python_adafruit_sgp30_do_method`、`python_adafruit_sgp30_attribute`
- 可调用入口：`Adafruit_SGP30`
- 对象方法：`iaq_init`、`iaq_measure`、`raw_measure`、`set_iaq_baseline`、`get_iaq_baseline`、`set_iaq_relative_humidity`
- 对象/模块属性：`eCO2`、`TVOC`、`raw_h2`、`raw_ethanol`
- API 文档：https://docs.circuitpython.org/projects/sgp30/en/latest/
