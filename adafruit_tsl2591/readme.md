# CircuitPython TSL2591 Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython TSL2591 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-tsl2591`
- 积木（3 个）：`python_adafruit_tsl2591_call`、`python_adafruit_tsl2591_do`、`python_adafruit_tsl2591_attribute`
- 可调用入口：`TSL2591`
- 对象方法：无
- 对象/模块属性：`lux`、`infrared`、`visible`、`full_spectrum`、`gain`、`integration_time`
- API 文档：https://docs.circuitpython.org/projects/tsl2591/en/latest/
