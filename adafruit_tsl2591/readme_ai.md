# @aily-project/lib-adafruit-tsl2591

Curated CircuitPython TSL2591 integration for the standalone CPython generator at `globalThis.Python`.

- Import: `import adafruit_tsl2591 as _python_lib_adafruit_tsl2591`
- Install on target: `python3 -m pip install adafruit-circuitpython-tsl2591`
- Blocks (3): `python_adafruit_tsl2591_call`, `python_adafruit_tsl2591_do`, `python_adafruit_tsl2591_attribute`
- Allowlisted callables: `TSL2591`
- Allowlisted methods: none
- Allowlisted attributes: `lux`, `infrared`, `visible`, `full_spectrum`, `gain`, `integration_time`
- API source: https://docs.circuitpython.org/projects/tsl2591/en/latest/
...
. .venv/bin/activate
python3 -m pip install --upgrade Adafruit-Blinka adafruit-circuitpython-tsl2591
```
