/* Curated CircuitPython VL53L0X bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython VL53L0X",
    "prefix": "python_adafruit_vl53l0x",
    "module": "adafruit_vl53l0x",
    "alias": "_python_lib_adafruit_vl53l0x",
    "importKey": "python_lib_adafruit_vl53l0x",
    "callables": [
      "VL53L0X"
    ],
    "methods": [
