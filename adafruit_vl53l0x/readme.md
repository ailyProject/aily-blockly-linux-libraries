# CircuitPython VL53L0X Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython VL53L0X 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-vl53l0x`
- 积木（5 个）：`python_adafruit_vl53l0x_call`、`python_adafruit_vl53l0x_do`、`python_adafruit_vl53l0x_method`、`python_adafruit_vl53l0x_do_method`、`python_adafruit_vl53l0x_attribute`
- 可调用入口：`VL53L0X`
- 对象方法：`start_continuous`、`stop_continuous`
- 对象/模块属性：`range`、`measurement_timing_budget`
- API 文档：https://docs.circuitpython.org/projects/vl53l0x/en/latest/
