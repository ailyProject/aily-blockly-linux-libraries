/* Curated CircuitPython VL53L1X bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython VL53L1X",
    "prefix": "python_adafruit_vl53l1x",
    "module": "adafruit_vl53l1x",
    "alias": "_python_lib_adafruit_vl53l1x",
    "importKey": "python_lib_adafruit_vl53l1x",
    "callables": [
      "VL53L1X"
    ],
    "methods": [
