# CircuitPython VL53L1X Blockly 库

面向树莓派和 Linux 单板机的 CircuitPython VL53L1X 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install adafruit-circuitpython-vl53l1x`
- 积木（5 个）：`python_adafruit_vl53l1x_call`、`python_adafruit_vl53l1x_do`、`python_adafruit_vl53l1x_method`、`python_adafruit_vl53l1x_do_method`、`python_adafruit_vl53l1x_attribute`
- 可调用入口：`VL53L1X`
- 对象方法：`start_ranging`、`stop_ranging`、`clear_interrupt`
- 对象/模块属性：`distance`、`distance_mode`、`timing_budget`、`data_ready`、`roi`
- API 文档：https://docs.circuitpython.org/projects/vl53l1x/en/latest/
