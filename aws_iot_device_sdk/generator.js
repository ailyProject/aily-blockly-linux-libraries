/* Curated AWS IoT Device SDK v2 bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "AWS IoT Device SDK v2",
    "prefix": "python_aws_iot_device_sdk",
    "module": "awsiot.mqtt_connection_builder",
    "alias": "_python_lib_aws_iot_device_sdk",
    "importKey": "python_lib_aws_iot_device_sdk",
    "callables": [
      "mtls_from_path",
      "mtls_from_bytes",
