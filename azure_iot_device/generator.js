/* Curated Azure IoT Device bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "Azure IoT Device",
    "prefix": "python_azure_iot_device",
    "module": "azure.iot.device",
    "alias": "_python_lib_azure_iot_device",
    "importKey": "python_lib_azure_iot_device",
    "callables": [
      "IoTHubDeviceClient.create_from_connection_string",
      "IoTHubDeviceClient.create_from_symmetric_key",
      "IoTHubModuleClient.create_from_connection_string",
      "Message",
      "MethodResponse"
    ],
    "methods": [
