/* Curated Bleak Bluetooth LE bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "Bleak Bluetooth LE",
    "prefix": "python_bleak",
    "module": "bleak",
    "alias": "_python_lib_bleak",
    "importKey": "python_lib_bleak",
    "callables": [
      "BleakScanner",
