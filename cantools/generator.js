/* Curated cantools bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "cantools",
    "prefix": "python_cantools",
    "module": "cantools",
    "alias": "_python_lib_cantools",
    "importKey": "python_lib_cantools",
    "callables": [
      "database.load_file",
      "database.load_string",
      "database.load"
    ],
    "methods": [
      "encode_message",
