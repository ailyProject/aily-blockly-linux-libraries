/* Curated dbus-next bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "dbus-next",
    "prefix": "python_dbus_next",
    "module": "dbus_next.aio",
    "alias": "_python_lib_dbus_next",
    "importKey": "python_lib_dbus_next",
    "callables": [
      "MessageBus"
    ],
    "methods": [
