/* Curated HailoRT Python bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "HailoRT Python",
    "prefix": "python_hailo_platform",
    "module": "hailo_platform",
    "alias": "_python_lib_hailo_platform",
    "importKey": "python_lib_hailo_platform",
    "callables": [
      "HEF",
      "VDevice",
      "Device",
