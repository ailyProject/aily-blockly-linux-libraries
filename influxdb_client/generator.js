/* Curated InfluxDB Client bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "prefix": "python_influxdb_client",
    "module": "influxdb_client",
    "alias": "_python_lib_influxdb_client",
    "importKey": "python_lib_influxdb_client",
    "callables": [
      "InfluxDBClient",
      "Point",
      "WriteOptions",
