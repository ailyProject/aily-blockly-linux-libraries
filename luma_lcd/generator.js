/* Curated luma.lcd bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "luma.lcd",
    "prefix": "python_luma_lcd",
    "module": "luma.lcd.device",
    "alias": "_python_lib_luma_lcd",
    "importKey": "python_lib_luma_lcd",
    "callables": [
      "st7735",
      "st7789",
      "ili9341",
