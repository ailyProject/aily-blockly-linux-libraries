...
面向树莓派和 Linux 单板机的 luma.lcd 常用 API 白名单积木。

- 目标端安装：`python3 -m pip install luma.lcd`
- 积木（5 个）：`python_luma_lcd_call`、`python_luma_lcd_do`、`python_luma_lcd_method`、`python_luma_lcd_do_method`、`python_luma_lcd_attribute`
- 可调用入口：`st7735`、`st7789`、`ili9341`、`pcd8544`
- 对象方法：`display`、`clear`、`show`、`hide`、`contrast`、`cleanup`
- 对象/模块属性：`width`、`height`、`size`、`mode`、`bounding_box`
- API 文档：https://luma-lcd.readthedocs.io/
