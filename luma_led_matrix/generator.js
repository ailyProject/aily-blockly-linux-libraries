/* Curated luma.led_matrix bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "luma.led_matrix",
    "prefix": "python_luma_led_matrix",
    "module": "luma.led_matrix.device",
    "alias": "_python_lib_luma_led_matrix",
    "importKey": "python_lib_luma_led_matrix",
    "callables": [
      "max7219",
      "ws2812"
    ],
