/* Curated luma.oled bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "luma.oled",
    "prefix": "python_luma_oled",
    "module": "luma.oled.device",
    "alias": "_python_lib_luma_oled",
    "importKey": "python_lib_luma_oled",
    "callables": [
      "ssd1306",
      "ssd1325",
      "ssd1331",
