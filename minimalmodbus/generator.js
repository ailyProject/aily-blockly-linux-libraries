/* Curated MinimalModbus bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "MinimalModbus",
    "prefix": "python_minimalmodbus",
    "module": "minimalmodbus",
    "alias": "_python_lib_minimalmodbus",
    "importKey": "python_lib_minimalmodbus",
    "callables": [
      "Instrument"
    ],
    "methods": [
