/* Curated CircuitPython NeoPixel bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "CircuitPython NeoPixel",
    "prefix": "python_neopixel",
    "module": "neopixel",
    "alias": "_python_lib_neopixel",
    "importKey": "python_lib_neopixel",
    "callables": [
      "NeoPixel"
    ],
    "methods": [
