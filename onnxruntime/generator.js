/* Curated ONNX Runtime bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "ONNX Runtime",
    "prefix": "python_onnxruntime",
    "module": "onnxruntime",
    "alias": "_python_lib_onnxruntime",
    "importKey": "python_lib_onnxruntime",
    "callables": [
      "InferenceSession",
      "SessionOptions",
