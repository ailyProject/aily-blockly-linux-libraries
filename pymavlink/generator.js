/* Curated pymavlink bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "pymavlink",
    "prefix": "python_pymavlink",
    "module": "pymavlink.mavutil",
    "alias": "_python_lib_pymavlink",
    "importKey": "python_lib_pymavlink",
    "callables": [
      "mavlink_connection",
      "mode_string_v10",
      "all_printable",
