/* Curated PyModbus bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "PyModbus",
    "prefix": "python_pymodbus",
    "module": "pymodbus.client",
    "alias": "_python_lib_pymodbus",
    "importKey": "python_lib_pymodbus",
    "callables": [
      "ModbusTcpClient",
      "ModbusSerialClient",
      "ModbusUdpClient",
