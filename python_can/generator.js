/* Curated python-can bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "python-can",
    "prefix": "python_python_can",
    "module": "can",
    "alias": "_python_lib_python_can",
    "importKey": "python_lib_python_can",
    "callables": [
      "Bus",
      "Message",
      "Notifier",
