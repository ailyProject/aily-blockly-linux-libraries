/* Curated python-periphery bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "prefix": "linux_periphery",
    "module": "periphery",
    "alias": "_python_lib_python_periphery",
    "importKey": "python_lib_python_periphery",
    "callables": [
      "GPIO",
      "LED",
      "PWM",
