/* Curated python-socketio bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "prefix": "python_python_socketio",
    "module": "socketio",
    "alias": "_python_lib_python_socketio",
    "importKey": "python_lib_python_socketio",
    "callables": [
      "Client",
      "AsyncClient",
      "Server",
