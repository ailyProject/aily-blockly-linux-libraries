/* Curated pyudev bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "prefix": "linux_pyudev",
    "module": "pyudev",
    "alias": "_python_lib_pyudev",
    "importKey": "python_lib_pyudev",
    "callables": [
      "Context",
      "Monitor",
      "MonitorObserver",
      "Devices.from_path",
      "Devices.from_device_file",
      "Devices.from_device_number"
    ],
    "methods": [
      "list_devices",
      "filter_by",
