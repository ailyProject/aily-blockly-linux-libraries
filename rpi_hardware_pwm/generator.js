/* Curated Raspberry Pi Hardware PWM bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "Raspberry Pi Hardware PWM",
    "prefix": "rpi_hardware_pwm",
    "module": "rpi_hardware_pwm",
    "alias": "_python_lib_rpi_hardware_pwm",
    "importKey": "python_lib_rpi_hardware_pwm",
    "callables": [
      "HardwarePWM"
    ],
    "methods": [
