/* Curated Sense HAT Emulator bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "Sense HAT Emulator",
    "prefix": "rpi_sense_emu",
    "module": "sense_emu",
    "alias": "_python_lib_rpi_sense_emu",
    "importKey": "python_lib_rpi_sense_emu",
    "callables": [
      "SenseHat"
    ],
    "methods": [
