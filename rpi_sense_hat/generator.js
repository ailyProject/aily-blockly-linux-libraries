/* Curated Sense HAT bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "Sense HAT",
    "prefix": "rpi_sense_hat",
    "module": "sense_hat",
    "alias": "_python_lib_rpi_sense_hat",
    "importKey": "python_lib_rpi_sense_hat",
    "callables": [
      "SenseHat"
    ],
    "methods": [
