/* Curated scikit-image I/O bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "scikit-image I/O",
    "prefix": "python_scikit_image",
    "module": "skimage.io",
    "alias": "_python_lib_scikit_image",
    "importKey": "python_lib_scikit_image",
    "callables": [
      "imread",
      "imsave",
      "imshow",
