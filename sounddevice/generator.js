/* Curated python-sounddevice bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "prefix": "python_sounddevice",
    "module": "sounddevice",
    "alias": "_python_lib_sounddevice",
    "importKey": "python_lib_sounddevice",
    "callables": [
      "play",
      "rec",
      "playrec",
