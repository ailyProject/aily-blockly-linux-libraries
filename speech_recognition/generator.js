/* Curated SpeechRecognition bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "prefix": "python_speech_recognition",
    "module": "speech_recognition",
    "alias": "_python_lib_speech_recognition",
    "importKey": "python_lib_speech_recognition",
    "callables": [
      "Recognizer",
      "Microphone",
      "AudioFile"
