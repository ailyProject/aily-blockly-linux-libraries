/* Curated LiteRT / TFLite Runtime bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "LiteRT / TFLite Runtime",
    "prefix": "python_tflite_runtime",
    "module": "tflite_runtime.interpreter",
    "alias": "_python_lib_tflite_runtime",
    "importKey": "python_lib_tflite_runtime",
    "callables": [
      "Interpreter",
      "load_delegate"
    ],
