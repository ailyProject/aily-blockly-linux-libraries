/* Curated Ultralytics bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "Ultralytics",
    "prefix": "python_ultralytics",
    "module": "ultralytics",
    "alias": "_python_lib_ultralytics",
    "importKey": "python_lib_ultralytics",
    "callables": [
      "YOLO",
      "RTDETR",
      "SAM",
