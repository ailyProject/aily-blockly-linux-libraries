/* Curated W1ThermSensor bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "W1ThermSensor",
    "prefix": "python_w1thermsensor",
    "module": "w1thermsensor",
    "alias": "_python_lib_w1thermsensor",
    "importKey": "python_lib_w1thermsensor",
    "callables": [
      "W1ThermSensor",
      "Unit"
    ],
