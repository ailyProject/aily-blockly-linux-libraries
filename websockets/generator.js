/* Curated websockets bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "websockets",
    "prefix": "python_websockets",
    "module": "websockets",
    "alias": "_python_lib_websockets",
    "importKey": "python_lib_websockets",
    "callables": [
      "connect",
      "serve",
      "broadcast"
