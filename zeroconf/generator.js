/* Curated python-zeroconf bridge for Raspberry Pi and Linux CPython projects. */
(function (root, spec) {
  'use strict';
  ...
  if (attributes.size) {
    ...
    "title": "python-zeroconf",
    "prefix": "python_zeroconf",
    "module": "zeroconf",
    "alias": "_python_lib_zeroconf",
    "importKey": "python_lib_zeroconf",
    "callables": [
      "Zeroconf",
      "ServiceInfo",
      "ServiceBrowser",
